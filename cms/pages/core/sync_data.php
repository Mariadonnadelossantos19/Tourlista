      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <?php
            ...
            ?>
            <!-- /.card -->
            <form id="task_form" action="../crud/importData.php" method="post" enctype="multipart/form-data">
            <div class="card">
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">CSV Template for Daily Accommodation Establishment Visitors Monitoring</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              <div class="form-group">
                  ...
                  <a href="../reports/AE_MONITORING_TEMPLATE.xlsx" download><button type="button" class="btn btn-info">Download Now!</button></a>
              </div>
              </div>
              <!-- /.card-body -->
            </div>
