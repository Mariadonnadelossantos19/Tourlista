<?php
  ...
  recordLog("Visited TA Daily Update");
      ...
      <div class="row">
          ...
          <div class="card">
              ...
              <table class="table table-bordered table-hover" style="text-align: left;">
                  ...
                  $sql = "select * from ta_daily_task where user_id = '".$_SESSION['id']."' and year = '".date("Y")."' and month = '".$_GET['month']."' and day = '".$x."' order by task_date asc";
                  $result = mysqli_query($conn, $sql);
