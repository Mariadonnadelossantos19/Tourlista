<?php 
  ...
  recordLog("Visited AE Daily Task");
...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper" <?php if(true){echo "onload='alerto()'";} ?>>
    <!-- Content Header (Page header) -->
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Daily Accommodation Monitoring </h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Daily Accommodation Monitoring </li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
            <div class="col-12">
            <form id="task_form" action="../crud/save_daily_task_ae.php" method="POST">
            <div class="card">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="input-group date">
                            ...
                            <input type="date" name="task_date" min="<?= date('Y-m-01'); ?>" max="<?= date('Y-m-t'); ?>" class="form-control" placeholder="Select Date" title="Date visitors checked-in" required>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
        ...
        <div class="modal-body">
          <table class="table table-striped">
            ...
            <tbody>
              ...
              <tr>
                <td>Domestic Visitors Details</th>
          ...
          <div class="card">
              ...
              <table class="table table-striped" style="text-align: left;">
                  ...
                  <?php
                      ...
                      for ($x = 1; $x <= date("t"); $x++) {
                          $sql = "SELECT ae_task_id, task_date, day, month, year, no_rooms_occupied, no_stayed_overnight, no_male, no_female, local_tourist, foreign_tourist, overseas_filipino, remarks FROM ae_daily_task WHERE user_id = '".$_SESSION['id']."' AND task_date LIKE '".date("Y-m")."%' AND day = '".$x."' ORDER BY task_date ASC";
                          $result = mysqli_query($conn, $sql);
                          ...
                          if (mysqli_num_rows($result) > 0) {
                              while ($row = mysqli_fetch_assoc($result)) {
                                  ...
                                  if ($rate >= 0 && $rate < 26) { // 0 - 25
                                      $ratecolor = "danger";
                                  } elseif ($rate > 25 && $rate < 51) { // 26 - 50
                                      $ratecolor = "warning";
                                  } elseif ($rate > 50 && $rate < 76) { // 51 - 75
                                      $ratecolor = "primary";
                                  } elseif ($rate > 75 && $rate < 101) { // 76 - 100
                                      $ratecolor = "success";
                                  }
                                  ...
                                  echo '<tr>
                                      ...
                                      <td>
                                          ...
                                          <a title="Edit" onclick="update('.$row["ae_task_id"].')"><button class="btn btn-success btn-xs"><i class="fas fa-edit"></i></button></a>';
                              ...
                              echo "<tr><td>".date("F")." ".$x."</td><td colspan='7'>No daily accommodation data encoded for this date</td></tr>";
                          }
                      }
                      ?>
                  ...
                  <tr>
                    ...
                    <?php
                        ...
                        if ($num != 0) {
                          ...
                          //  echo $totalOccupancy." / ".$totalrooms." x ". $num. "-". $totalOccupancy;
                            $occupancyStyle = "";
...
function deleteRecord(id){
  ...
  if (r == true) {
    window.location.href = "../crud/delete_ae_task.php?id="+id;
    window.location.href = "../crud/delete_ae_task.php?m=<?=date("m");?>&y=<?=date("Y");?>&id="+id;
  }
}
function setMaxN(){
