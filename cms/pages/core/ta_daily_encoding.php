<?php
  ...
  recordLog("Visited TA Daily Encoding");

  $error = 0;
  $sqlz = "select * from ae_daily_task a left join accommodation_establishment b on a.ae_id = b.ae_id where approve_status = '1' and a.user_id = '".$_SESSION['ta_user']."'";
  ...
  <div class="content-wrapper" <?php if($error>0){echo "onload='alerto()'";} ?>>
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
            <div class="col-12">
            <form action="../crud/save_ta_daily_update.php" method="POST">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <?php
                    ...
                    $sql = "select ta_id, ta_name, approve_status from tourist_attraction where user_id='".$_SESSION['ta_user']."'";
                ...
                <div class="col-md-3">
                    ...
                    <div class="input-group date">
                        ...
                        <?php
                            ...
                            ?>
                            <input type="date" name="task_date"  min="<?= date("Y")."-".$month; ?>-01" max="<?= date("Y")."-".$month."-".$num_days; ?>"  class="form-control pull-right" placeholder="Select Date" title="Date of visit" required>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
      ...
      <div class="row">
          ...
          <div class="card">
              ...
              <table class="table table-bordered table-hover" style="text-align: left;">
                  ...
                  $sql = "select * from ta_daily_task where user_id = '".$_SESSION['ta_user']."' and year = '".date("Y")."' and month = '".$_GET['month']."' and day = '".$x."' order by task_date asc";
                  $result = mysqli_query($conn, $sql);
                        ...
                        while($row = mysqli_fetch_assoc($result)) {
                              ...
                              $date=date_create($row["task_date"]);
                                    ...
                                    '<tr style="text-align: center;">
                                          ...
                                          <td><b>'.$total.'</b></td>
                                          <td>
                                          <a href="../crud/delete_ta_update.php?id='.$row["ta_task_id"].'&month='.$_GET['month'].'"  title="Delete"> <button class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></button> </a>
                                          </td>
                                    </tr>';
                                }
                              }
