<?php
  ...
  $error = 0;
  $sqlz = "select * from ae_daily_task a left join accommodation_establishment b on a.ae_id = b.ae_id where approve_status = '1' and a.user_id = '".$_SESSION['ae_user']."'";
        ...
        <div class="row">
            ...
            <div class="card">
              <div class="card-header">
                ...
                $sql = "select ae_id, ae_name, no_rooms, approve_status from accommodation_establishment where user_id='".$_SESSION['ae_user']."'";
            ...
            <div class="card-footer">
                ...
                <a href="ae_daily_encoding.php"><button style="display: none;" type="button" id="cancel_button" class="btn btn-default float-left">Cancel</button></a>
            </div>
            </form>
            </div>
            </div>
          ...
          <div class="card">
              ...
              <table class="table table-striped" style="text-align: left;">
                  ...
                  <?php
                      ...
                      $sql1 = "SELECT no_rooms FROM accommodation_establishment WHERE user_id = '".$_SESSION['ae_user']."'";
                      ...
                      for ($x = 1; $x <= $d; $x++) {
                          ...
                          $sql = "SELECT ae_task_id, task_date, day, month, year, no_rooms_occupied, no_stayed_overnight, no_male, no_female, local_tourist, foreign_tourist, overseas_filipino, remarks 
                                  FROM ae_daily_task 
                                  WHERE user_id = '".$_SESSION['ae_user']."' AND day = '".$x."' AND month = '".$_GET["month"]."' AND year = '".$_GET['year']."' 
                          ...
                          if (mysqli_num_rows($result) > 0) {
                              while ($row = mysqli_fetch_assoc($result)) {
                                  ...
                                  $sql1 = "SELECT * FROM ae_daily_task WHERE user_id = '".$_SESSION['ae_user']."' AND task_date LIKE '".date("Y-m")."%' AND day = '".($x+1)."'";
                                  $result1 = mysqli_query($conn, $sql1);
                                  if (mysqli_num_rows($result1) > 0) {
