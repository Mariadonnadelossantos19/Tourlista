<?php
  ...
  recordLog("Visited TA MICE");

  $error = 0;
  $sqlz = "select * from ta_daily_task a left join tourist_attraction b on a.ta_id = b.ta_id where approve_status = '1' and a.user_id = '".$_SESSION['id']."'";
...
<?php
            ...
            $sql = "select ta_id, ta_name from tourist_attraction where user_id='".$_SESSION['id']."'";
  ...
  <div class="content-wrapper" <?php if($error>0){echo "onload='alerto()'";} ?>>
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
            <div class="col-12">
            <form id="task_form" action="../crud/save_mice_ta.php" method="POST">
            <div class="card">
              <div class="card-header">
                ...
                <?php
                  ...
                  if (mysqli_num_rows($result) > 0) {
                      while($row = mysqli_fetch_assoc($result)) {
                          echo "Activity / Event at ".$row["ta_name"]." <input type='hidden' name='ta_id' value='".$row["ta_id"]."' />";
                          $disabled = "";
                      }
                  }
                ?>
              ...
              <input type="hidden" id="mice_id" name="mice_id" />
                <div class="row">
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            <label>Number of Local Visitors</label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            <label>Number of Foreign Visitors</label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="foreign_details" id="foreign_details" class="form-control" value="{}" placeholder="No Foreign Tourist per Country" readonly required>
                            </div>
                        </div>
                    </div>
                    <div class="col-3">
                        ...
                        while($row = mysqli_fetch_assoc($result)) {
                              ...
                              $date=date_create($row["mice_date"]);
                                    ...
                                    '<tr>
                                          ...
                                          <a href="../crud/delete_mice.php?id='.$row["mice_id"].'" title="Delete"> <button class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></button></a>
                                          </td>
                                    </tr>';
                                }
                              }
                  ...
                  <tr>
                    ...
                    <?php
                        ...
                        if ($totalPeople != 0) {
                            ...
                            $malerate = number_format(($totalMale / $totalPeople) * 100, 2); // Format to 2 decimal places
                        } else {
                            // Handle the case where the total number of people is zero
                            $malerate = 0; // Default value
                        }

                        // Initialize male style
                        $maleStyle = "";

                        // Determine the male style based on the male rate
                        if ($malerate >= 0 && $malerate < 26) {
                            $maleStyle = "red";
                        } elseif ($malerate >= 26 && $malerate < 51) {
                            $maleStyle = "yellow";
                        } elseif ($malerate >= 51 && $malerate < 76) {
                            $maleStyle = "blue";
                        } elseif ($malerate >= 76 && $malerate <= 100) {
                            $maleStyle = "green";
                        }
                        ?>
                  ...
                  <tr>
                    ...
                    <?php
                        ...
                        if ($totalPeople != 0) {
                            ...
                            $femalerate = number_format(($totalFemale / $totalPeople) * 100, 2); // Format to 2 decimal places
                        } else {
                            // Handle the case where the total number of people is zero
                            $femalerate = 0; // Default value
                        }

                        // Initialize female style
                        $femaleStyle = "";

                        // Determine the female style based on the female rate
                        if ($femalerate >= 0 && $femalerate < 26) {
                            $femaleStyle = "red";
                        } elseif ($femalerate >= 26 && $femalerate < 51) {
                            $femaleStyle = "yellow";
                        } elseif ($femalerate >= 51 && $femalerate < 76) {
                            $femaleStyle = "blue";
                        } elseif ($femalerate >= 76 && $femalerate <= 100) {
                            $femaleStyle = "green";
                        }
                        ?>
                  ...
                  <tr>
                    ...
                    <?php
                          ...
                          if ($totalPeople != 0) {
                              ...
                              $localrate = number_format(($totalLocal / $totalPeople) * 100, 2); // Format to 2 decimal places
                          } else {
                              // Handle the case where the total number of people is zero
                              $localrate = 0; // Default value
                          }

                          // Initialize local style
                          $localStyle = "";

                          // Determine the local style based on the local rate
                          if ($localrate >= 0 && $localrate < 26) {
                              $localStyle = "red";
                          } elseif ($localrate >= 26 && $localrate < 51) {
                              $localStyle = "yellow";
                          } elseif ($localrate >= 51 && $localrate < 76) {
                              $localStyle = "blue";
                          } elseif ($localrate >= 76 && $localrate <= 100) {
                              $localStyle = "green";
                          }
                          ?>
                  ...
                  <tr>
                    ...
                    <?php
                            ...
                            if ($totalPeople != 0) {
                                ...
                                $foreignrate = number_format(($totalForeign / $totalPeople) * 100, 2); // Format to 2 decimal places
                            } else {
                                // Handle the case where the total number of people is zero
                                $foreignrate = 0; // Default value
                            }

                            // Initialize foreign style
                            $foreignStyle = "";

                            // Determine the foreign style based on the foreign rate
                            if ($foreignrate >= 0 && $foreignrate < 26) {
                                $foreignStyle = "red";
                            } elseif ($foreignrate >= 26 && $foreignrate < 51) {
                                $foreignStyle = "yellow";
                            } elseif ($foreignrate >= 51 && $foreignrate < 76) {
                                $foreignStyle = "blue";
                            } elseif ($foreignrate >= 76 && $foreignrate <= 100) {
                                $foreignStyle = "green";
                            }
                            ?>
