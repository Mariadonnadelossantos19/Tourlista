<?php
      ...
      if($_SESSION['id']=="") header("Location:../../../");
        ...
        use PHPMailer\PHPMailer\Exception;
          ...
          recordLog("Approved tourist attraction name edit request with ID=".$_GET['id']);
          $id=$_GET['id'];
          $email = "";
          $username = "";
          $sql = "UPDATE tourist_attraction set request_edit='2' WHERE ta_id='".$id."'";
          if (mysqli_query($conn, $sql)) {
            ...
            //EMAIL
			  $to = $email;
			  $subject = "TourLISTA Tourist Attraction Name Updating Approval";
			  $message = "
			  Dear USER - ".$username.",
		      <br><br> 
			  Your request to edit your tourist attraction name has been successfully granted by your LGU Web Administrator <br />
			  You may now update your tourist attraction name in the TourLISTA Content Management System.<br />
