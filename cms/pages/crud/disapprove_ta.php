<?php
      ...
      if($_SESSION['id']=="") header("Location:../../../");
        ...
        use PHPMailer\PHPMailer\Exception;
          ...
          recordLog("Disapproved TA with ID=".$_GET['id']);
          $id=$_GET['id'];
          $sql = "UPDATE tourist_attraction set approve_status='2' WHERE ta_id='".$id."'";
          if (mysqli_query($conn, $sql)) {
          //QUERY FOR USER DETAILS
          $sql1 = "select username,a.email as email from ts_users a left join tourist_attraction b on a.user_id = b.user_id where ta_id = '".$id."'";
          ...
          //EMAIL
            $to = $email;
            $subject = "TourLISTA Tourist Attraction Registration Disapproval";
            $message = "
            Dear USER - ".$username.",
            <br><br> 
            We regret to inform you that your tourist attraction enrollment has been disapproved by your LGU Web Administrator. <br />
            Please review the requirements and ensure all necessary information is provided before resubmitting your application.<br />
            For further assistance, you may contact your LGU Web Administrator.
