<?php
      ...
      if($_SESSION['id']=="") header("Location:../../../");
        ...
        use PHPMailer\PHPMailer\Exception;
          ...
          recordLog("Disapproved AE with ID=".$_GET['id']);
          $id=$_GET['id'];
          $sql = "UPDATE accommodation_establishment set approve_status='2' WHERE ae_id='".$id."'";
          if (mysqli_query($conn, $sql)) {
            ...
            //EMAIL
			  $to = $email;
			  $subject = "TourLISTA Accommodation Establishment Registration Disapproval";
			  $message = "
			  Dear USER - ".$username.",
		      <br><br> 
			  We regret to inform you that your accommodation establishment enrollment has been disapproved by your LGU Web Administrator. <br />
