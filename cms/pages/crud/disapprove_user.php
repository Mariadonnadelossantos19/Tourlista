<?php
      ...
      if($_SESSION['id']=="") header("Location:../../../");
        ...
        use PHPMailer\PHPMailer\Exception;
          ...
          recordLog("Disapproved user with ID=".$_GET['id']);
          $id=$_GET['id'];
          $mobile = "";
          $email = "";
          $username = "";
                    ...
                    //DISAPPROVE
          $sql = "UPDATE ts_users set status='2' WHERE user_id='".$id."'";
          if (mysqli_query($conn, $sql)) {
              //EMAIL
			  $to = $email;
			  $subject = "TourLISTA Application Registration Disapproval";
			  $message = "
			  Dear USER - ".$username.",
		      <br><br> 
                We regret to inform you that your account registration has been disapproved by your LGU Web Administrator. <br />
                Please review the requirements and ensure all necessary information is provided before resubmitting your application.<br />
                For further assistance, you may contact your LGU Web Administrator.<br />
			  <br /> <br /> 
