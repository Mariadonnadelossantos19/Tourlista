<?php
      ...
      if($_SESSION['id']=="") header("Location:../../../");
        ...
        use PHPMailer\PHPMailer\Exception;
          ...
          recordLog("Approved accommodation establishment name edit request with ID=".$_GET['id']);
          $id=$_GET['id'];
          $email = "";
          $username = "";
          $sql = "UPDATE accommodation_establishment set request_edit='2' WHERE ae_id='".$id."'";
          if (mysqli_query($conn, $sql)) {
            ...
            //EMAIL
			  $to = $email;
			  $subject = "TourLISTA Accommodation Establishment Name Updating Approval";
			  $message = "
			  Dear USER - ".$username.",
		      <br><br> 
			  Your request to edit your accommodation establishment name has been successfully granted by your LGU Web Administrator <br />
			  You may now update your accommodation establishment name in the TourLISTA Content Management System.<br />
