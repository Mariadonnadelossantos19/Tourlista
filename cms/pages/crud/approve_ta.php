<?php
      ...
      if($_SESSION['id']=="") header("Location:../../../");
        ...
        use PHPMailer\PHPMailer\Exception;
          ...
          recordLog("Approved tourist attraction with ID=".$_GET['id']);
          $id=$_GET['id'];
          $email = "";
          $username = "";
          $sql = "UPDATE tourist_attraction set approve_status='1' WHERE ta_id='".$id."'";
          if (mysqli_query($conn, $sql)) {
            ...
            //EMAIL
			  $to = $email;
			  $subject = "TourLISTA Tourist Attraction Registration Approval";
			  $message = "
			  Dear USER - ".$username.",
		      <br><br> 
			  Your tourist attraction enrollment has been successfully approved by your LGU Web Administrator <br />
