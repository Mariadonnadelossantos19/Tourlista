 ...
 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <!-- SELECT2 EXAMPLE -->
        <form action="../backend/update_training.php" method="get">
          ...
          <div class="card-body">
            <div class="row">
                <div class="col-md-9">
                  <div class="form-group">
                    <label>Title *</label>
                    <input class="form-control" name="training_title" type="text" placeholder="Enter Forum/Training/Seminar Title" style="width: 100%;" value="<?= $training_title ?>" required>
                  </div>  
                  <!-- /.form-group -->
                </div>
                <div class="col-md-3">
                  ...
                  <?php
                      ...
                      if ($result->num_rows > 0) {
                          while($row = $result->fetch_assoc()) {
                              echo '<option value="'.$row["fr_type_id"].'"'; if($training_type==$row['fr_type_id']){ echo 'selected'; } echo '>'.$row["fr_type_name"].'</option>';
                          }
                      } 
                      $conn->close();
                    ?>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="training_desc" type="text" placeholder="Enter Training Description" style="width: 100%;"><?= $training_desc ?></textarea>
                </div>  
                <!-- /.form-group -->
              </div>
            </div>
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <select class="select2" name="cooperating_agencies" multiple="multiple" data-placeholder="Select Cooperating Agency" style="width: 100%;">
                  ...
                  <?php
                      ...
                      if ($result->num_rows > 0) {
                          while($row = $result->fetch_assoc()) {
                              echo '<option value="'.$row["coop_id"].'"'; if($cooperator==$row['coop_id']){ echo 'selected'; } echo '>'.$row["coop_name"].'</option>';
                          }
                      } 
                      $conn->close();
                    ?>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <?php
                      ...
                      if ($result->num_rows > 0) {
                          while($row = $result->fetch_assoc()) {
                              echo '<option value="'.$row["sp_id"].'"'; if($service_provider==$row['sp_id']){ echo 'selected'; } echo '>'.$row["sp_name"].'</option>';
                          }
                      } 
                      $conn->close();
                    ?>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <?php
                      ...
                      if ($result->num_rows > 0) {
                          while($row = $result->fetch_assoc()) {
                              echo '<option value="'.$row["sector_id"].'"'; if($sectors==$row['sector_id']){ echo 'selected'; } echo '>'.$row["sector_name"].'</option>';
                          }
                      } 
                      $conn->close();
                    ?>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control" name="start_date" type="date" value="<?= $start_date ?>" style="width: 100%;" required>
                </div>  
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control" name="end_date" type="date" value="<?= $end_date ?>" style="width: 100%;" required>
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="requesting_party" type="text" placeholder="Enter Requesting Party" style="width: 100%;"><?= $requesting_party ?></textarea>
                </div>  
                <!-- /.form-group -->
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                  <label>Cost</label>
                  <input class="form-control" name="training_cost" type="number" step="0.01" placeholder="Enter Consultancy Cost" style="width: 100%;" value="<?= $training_cost ?>" required>
                </div>  
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input class="form-control" name="overall_csf" type="number" placeholder="Enter Overall CSF Rating" step="0.01" value="<?= $overall_csf ?>" style="width: 100%;" required>
                </div>
                <!-- /.form-group -->
              </div>
              <div class="col-md-4">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  <label>Remarks</label>
                  <textarea class="form-control" name="remarks" type="text" placeholder="Enter Remarks" style="width: 100%;"><?= $remarks ?></textarea>
                </div>  
                <!-- /.form-group -->
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input class="form-control" name="female_participants" type="number" max="99999999" value="<?= $female_participants ?>" placeholder="Enter No. of Female Participants" style="width: 100%;" required>
                </div>  
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input class="form-control" name="male_participants" type="number" max="99999999" value="<?= $male_participants ?>" placeholder="Enter No. of Male Participants" style="width: 100%;"></div>
                <!-- /.form-group -->
              </div>
              <div class="col-md-4">
                <div class="form-group">
                  <label>No. of PWD Participants *</label>
                  <input class="form-control" name="pwd_participants" type="number" max="99999999" value="<?= $pwd_participants ?>" placeholder="Enter No. of PWD Participants" style="width: 100%;">
                </div>
                <!-- /.form-group -->
                </div>
              <!-- /.col -->
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input class="form-control" name="sr_participants" type="number" max="99999999" value="<?= $sr_participants ?>" placeholder="Enter No. of Senior Citizen Participants " style="width: 100%;" required>
                </div>  
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input class="form-control" name="firm_participants" type="number" max="99999999" value="<?= $firm_participants ?>" placeholder="Enter Total No. of Participating Firms" style="width: 100%;"></div>
                <!-- /.form-group -->
              </div>
              <div class="col-md-4">
                <div class="form-group">
                  <label>Total No. of Participating PO *</label>
                  <input class="form-control" name="po_participants" type="number" max="99999999" value="<?= $po_participants ?>" placeholder="Enter Total No. of Participating PO" style="width: 100%;">
                </div>
                <!-- /.form-group -->
                </div>
              <!-- /.col -->
          ...
          <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input class="form-control" name="street" type="text" value="<?= $street ?>" placeholder="Enter Street Address" style="width: 100%;">
                </div>  
                <!-- /.form-group -->
