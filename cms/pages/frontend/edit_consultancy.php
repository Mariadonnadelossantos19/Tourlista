  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <?php
                      ...
                      if ($result->num_rows > 0) {
                          while($row = $result->fetch_assoc()) {
                              echo '<option value="'.$row["project_id"].'"'; if($project==$row['project_id']){ echo 'selected'; } echo '>'.$row["project_title"].'</option>';
                          }
                      } 
                      $conn->close();
                    ?>
              ...
              <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <?php
                      ...
                      if ($result->num_rows > 0) {
                          while($row = $result->fetch_assoc()) {
                              echo '<option value="'.$row["con_type_id"].'"'; if($consultancy_type==$row['con_type_id']){ echo 'selected'; } echo '>'.$row["con_type_name"].'</option>';
                          }
                      } 
                      $conn->close();
                    ?>
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input class="form-control" name="consultancy_start" type="date" value="<?= $consultancy_start ?>" style="width: 100%;" required>
                </div>  
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input class="form-control" name="consultancy_end" type="date" value="<?= $consultancy_end ?>" style="width: 100%;" required>
                </div>
                <!-- /.form-group -->
              </div>
            ...
            <div class="row">
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <input class="form-control" name="no_participants" type="number" placeholder="Enter No. of Participants" value="<?= $no_participants ?>" style="width: 100%;" required>
                </div>  
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <input class="form-control" name="no_firms" type="number" placeholder="Enter No. of Firms" value="<?= $no_firms ?>" style="width: 100%;" required>
                </div>
                <!-- /.form-group -->
              </div>
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <input class="form-control" name="no_po" type="number" placeholder="Enter No. of PO" value="<?= $no_po ?>" style="width: 100%;" required>
                </div>
                <!-- /.form-group -->
              </div>
              ...
              <div class="col-md-3">
                <div class="form-group">
                  <label>Cost *</label>
                  <input class="form-control" name="consultancy_cost" type="number"  placeholder="Enter No. of Consultancy Cost" value="<?= $consultancy_cost ?>" style="width: 100%;" required>
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
          ...
          <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input class="form-control" name="street" type="text" placeholder="Enter Street Address" <?= $street ?> style="width: 100%;">
                </div>  
                <!-- /.form-group -->
        ...
        <input type="hidden" name="consultancy_id" value="<?= $consultancy_id ?>" />
